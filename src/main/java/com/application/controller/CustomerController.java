...
public class CustomerController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<Customer> findOne(@PathVariable int id) {
    ...
    public List<Customer> findAllFake() {
        ...
        customers.add(new Customer("customer1","Xcustomer1"));
        customerRepository.save(new Customer("customer1","Xcustomer1"));
        return customers;
